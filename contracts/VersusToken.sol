...
contract ERCStorage {
    ...
    function sendETH(uint256 amount) public {
        ...
        payable(versus).transfer(amount);
    }
}


contract Versus is ERC20, DataLayout, Proxiable {
    using SafeMath for uint256;
    ...
    function versusConstructor(uint256 _supply) public {
        require(!initialized);
        _owner = msg.sender;
        nativeCoin = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
        uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        //mint supply
        _mint(_owner, _supply);
        tokenStorage = address(new ERCStorage());
        constructor1("Versus Metaverse", "Versus");
        initialize();
    }
    ...
    function transfer(address recipient, uint256 amount) public override returns(bool) {
        ...
        switchToNativeCoin(fee);
        require(super.transfer(recipient, amount.sub(fee)), "Transfer failed");
        return true;
    }

    //transferFrom override

    function switchToNativeCoin(uint256 amount) internal {
